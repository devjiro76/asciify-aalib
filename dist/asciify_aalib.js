(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define('asciify_aalib', ['module', 'exports', 'aalib.js'], factory);
  } else if (typeof exports !== "undefined") {
    factory(module, exports, require('aalib.js'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.aalib);
    global.asciify_aalib = mod.exports;
  }
})(this, function (module, exports, _aalib) {
  'use strict';
  ...
  exports.default = class {
    ...
    svg() {
      return new Promise((resolve, reject) => {
        Promise.resolve().then(() => {
          ...
          const svg = '<svg xmlns="http://www.w3.org/2000/svg" ' + 'width="' + this.asciiWidth + '" height="' + this.asciiHeight + '">' + '<foreignObject width="100%" height="100%">' + '<div xmlns="http://www.w3.org/1999/xhtml">' + pre.outerHTML + '</div>' + '</foreignObject>' + '</svg>';
    ...
    createAsciiElement(asciiWidth, asciiHeight) {
      ...
      return new Promise(resolve => _aalib2.default.read.image.fromURL(this.imgSrc).map(_aalib2.default.filter.contrast(1.2)).map(_aalib2.default.aa({
        fontSize: 12,
        width: asciiWidth,
        height: asciiHeight,
        colored: true
      })).map(_aalib2.default.filter.brightness(0)).map(_aalib2.default.render.html({
        el: tempWrapper
